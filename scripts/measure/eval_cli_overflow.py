#!/usr/bin/env python3
"""Comment-overflow job × three repeats on llama3.1:8b.

  PYTHONPATH=src python scripts/measure/eval_cli_overflow.py

Starts from a list+show+mocks tree (the first-run checklist already
clean). Typed: add the comment subcommand and a mocked test.
Pass means overflow_gaps no longer lists comment.
Default --steps 12.
"""
...
TASK = "add the comment subcommand and a mocked test"
REPEATS = 3
STEPS = 12
