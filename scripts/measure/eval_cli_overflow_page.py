#!/usr/bin/env python3
"""Pagination-overflow job × three repeats on llama3.1:8b.

  PYTHONPATH=src python scripts/measure/eval_cli_overflow_page.py

Starts from a list+show+comment tree (first-run checklist and the
comment overflow already clean). Typed: add pagination to the GitHub
PR CLI. Pass means overflow_gaps no longer lists pagination.
Default --steps 12.
"""
...
TASK = "add pagination to the GitHub PR CLI"
REPEATS = 3
STEPS = 12
