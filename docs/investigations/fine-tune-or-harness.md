...
| 0.5B sample-and-run (18 scripts, MLX, 5 Sep 2026) | four drafts 6 / 18 base, 9 / 18 with repair; later loop 12 / 18 with 0 hint-repairs; greedy LoRA 0 / 54 | The adapter lost to the untuned base. An 8B note did not make the 0.5B debug itself. Freeze step 100 |
