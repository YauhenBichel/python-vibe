...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. Empty-VRAM SWE helper chat 43s. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | Empty-VRAM SWE helper chat 43s. Earlier 300s empty miss was not stable. Do not switch. |
