...
| 8B greenfield CLI | GitHub PR CLI, empty folder, 3 repeats | **3 / 3** after #220 (suite + `done`); overflow comment **3 / 3** after #222; pagination **3 / 3** after #233; config **0 / 3** |
| Everyday-ready bar | 15 parse prompts + ≥1 KB logic fix × 3 | after #229: harness parse **10 / 15** vs clean **0 / 15**; harness fix **0 / 3** (`[]` × 3) vs clean **3 / 3** |
