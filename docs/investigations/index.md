...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. SWE 180s walls shared the laptop with `bench.py` on the 8B. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | SWE 180s walls shared the laptop with `bench.py` on the 8B. Do not switch. |
