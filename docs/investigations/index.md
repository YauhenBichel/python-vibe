...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. Extra tags timed out on clamp, including after a warm load. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | OpenCoder and SWE-agent-LM are on disk. Clamp timed out at 180s even after a warm load. A 7B–8B Q4 fits 18 GB. |
