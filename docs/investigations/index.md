...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. SWE first helper chat 14.5s; daily first clamp still 180s. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | SWE first helper chat 14.5s; daily first clamp still 180s. Do not switch. |
