...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. SWE helper chat 37s swapping off the 8B. Idle empty still missed 300s. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | SWE helper chat 37s swapping off the 8B. Idle empty still missed 300s. Do not switch. |
