...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. Warm SWE helper 75s. Later an 8B client held `/api/chat`. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | Warm SWE helper 75s. Later an 8B client held `/api/chat`. Do not switch. |
