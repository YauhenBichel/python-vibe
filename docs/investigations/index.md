...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. Three extra tags miss a one-word generate. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | SWE-agent replies in 20s; OpenCoder misses a one-word generate. Do not switch. |
