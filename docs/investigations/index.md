...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. Listed SWE-agent missed a 60s `ok`; after expiry, 6.8s. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | Listed SWE-agent missed a 60s `ok`. After expiry, `ok` in 6.8s. Do not switch. |
