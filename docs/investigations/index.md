...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. Idle SWE one-word 7.4s. Agent first chat still missed 300s. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | Idle SWE one-word 7.4s. Agent first chat still missed 300s. Do not switch. |
