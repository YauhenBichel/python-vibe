...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. Extra tags miss a one-word generate inside 180s. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | OpenCoder and CodeLlama miss a one-word generate inside 180s. A 7B–8B Q4 fits 18 GB. Do not switch. |
