...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. One SWE daily clamp: 12 steps, no `clamp`. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | One SWE daily clamp: 12 steps, no `clamp`, 464s. Do not switch. |
