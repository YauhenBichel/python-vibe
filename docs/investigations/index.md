...
| --- | --- |
| [Which model]({{ '/investigations/which-model/' | relative_url }}) | Evening daily: 8B 9/9, 7B coder 7/9. SWE Agent body 180s without `keep_alive`; 116s with it. Keep the 8B. |
...
| [Hub models]({{ '/investigations/hub-models/' | relative_url }}) | SWE Agent body 180s without `keep_alive`; 116s with it. Do not switch. |
