...
- [Which model to run]({{ '/investigations/which-model/' | absolute_url }}): Same-night daily: 8B 9/9, 7B coder 7/9. Empty VRAM DeepSeek: first clamp passed, second hit 180s. 8B stays.
