...
- [Which model to run]({{ '/investigations/which-model/' | absolute_url }}): Same-night daily: 8B 9/9, 7B coder 7/9. DeepSeek first chat 54s from empty VRAM; 180s when swapping off the 7B. 8B stays.
