...
- [Live demo]({{ '/live/' | absolute_url }}): Typed session on demo/orders. 5 Sep 2026. Only ask called the 8B.
...
- [What the harness cannot fix]({{ '/investigations/limits/' | absolute_url }}): Six measurements where the harness knew something and it made no difference.
