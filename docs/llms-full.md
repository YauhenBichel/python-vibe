...
- OpenCoder 8B and SWE-agent-LM 7B imported from Hub GGUF (`import_hf_ollama.py`). Write-tests 3/3 is the compiler bind. Idle one-word 7.42s. Helper-sized Agent chat while the 8B was listed: 36.69s. Idle empty helper chat still missed 300s. Default stays 8B. Do not pull 14B or 30B.
