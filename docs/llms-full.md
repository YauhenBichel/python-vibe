...
- OpenCoder 8B and SWE-agent-LM 7B imported from Hub GGUF (`import_hf_ollama.py`). Write-tests 3/3 is the compiler bind. First helper clamp chat is ~1,700 tokens: 8B 17s, 7B 12s, DeepSeek 39s, SWE-agent-LM 33s. Daily still timed out on a cold load. Not a score. Default stays 8B. Do not pull 14B or 30B.
