...
- OpenCoder 8B and SWE-agent-LM 7B imported from Hub GGUF (`import_hf_ollama.py`). Write-tests 3/3 is the compiler bind. Idle one-word 7.42s. Helper chat swapping off the 8B 36.69s. Already-listed helper chat 74.83s (load 0.02s, 1,700 eval tokens). Idle empty still missed 300s. Default stays 8B. Do not pull 14B or 30B.
